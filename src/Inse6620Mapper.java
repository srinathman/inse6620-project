...
public class Inse6620Mapper extends Mapper<Object, Text, Text, IntWritable> {
	...
	public void map(Object key, Text value, Context context)
		...
		thisKey.set( splitLine[2] ) ;		
		context.write(thisKey, one);
		
		thisKey.set( splitLine[2] + "->" + splitLine[4]  ) ;		
		context.write(thisKey, one);
		
		thisKey.set( splitLine[4] + ":" + splitLine[5]  ) ;		
		context.write(thisKey, one);
